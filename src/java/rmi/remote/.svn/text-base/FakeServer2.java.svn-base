...
public class FakeServer2 extends UnicastRemoteObject implements RemoteTester {
    ...
    public static void main( String[] args ) {
        ...
        try {
            Naming.rebind("//localhost:7000/pappa" , new FakeServer2( random ));
        }
        catch ( Exception e ) {
            if ( true ) return;
        } 
    ...
    public FakeServer2( int a ) throws Exception {
        param = a;
    }
